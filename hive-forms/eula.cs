...
namespace TerminalWizard
{
  public class Eula
  {
    ...
    {
        var container = new FrameView("EULA")
        {
                Height = Dim.Percent(100),
                Width = Dim.Percent(100)
        };
        
        var _textView = new TextView()
        {
            X = 2,
            Y = 1,
